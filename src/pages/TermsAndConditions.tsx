...
const TermsAndConditions = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | ArShield</title>
        <meta name="description" content="Review the terms and conditions for using ArShield's cybersecurity services and website." />
        <meta name="keywords" content="terms and conditions, ArShield, cybersecurity, India, legal" />
        <link rel="canonical" href="https://arshield.in/terms-and-conditions" />
      </Helmet>
