...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      services: [
        ...
        'Framework Compliance (ISO 27001, NIST, GDPR, SEBI CSCRF, RBI IT GRC, IRDAI, PCI DSS)',
  ...
  return (
    <>
      <Helmet>
        <title>Cybersecurity Services | ArShield</title>
        <meta name="description" content="Comprehensive cybersecurity solutions inspired by ancient wisdom. Network security, VAPT, managed services, compliance, and more by ArShield." />
        <meta name="keywords" content="cybersecurity, VAPT, penetration testing, network security, managed security, compliance, ArShield, India, mythological security" />
        <link rel="canonical" href="https://arshield.in/services" />
      </Helmet>
